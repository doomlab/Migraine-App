  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    if (null != authToken && Authorize.checkAuthToken(authToken))
    {
      ...
      if (null != data)
      {
        ...
        if (null == user)
        {
          LOG.error("Invalid FAMS servlet request: User ID not found.");
        ...
        FamsSaveResponse re = new FamsSaveResponse();
        re.setSuccess(true);
        re.setMessage("FAMS entry saved.");
